...
<head>
  ...
  <meta name="facebook-domain-verification" content="gn4igu56jlryi8j682xf2b752wjhae" />
  ...
  <script>
    ...
    fbq('init', '271578525095739');
    fbq('track', 'PageView');
  </script>
  <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=271578525095739&ev=PageView&noscrip=1"
  /></noscript>
  <!-- End Meta Pixel Code -->
  ...
  <main>
    ...
    <!-- <section id="working">
      ...
      <article class="investor-background pb-5">
        ...
        <div class="paragraph">
          <p class="paragraph__text is-size-5-mobile is-size-4-tablet is-size-3-desktop">Obtén un retorno anual rentable
            y transparente invirtiendo en los rapibonos o prestabonos de RAPIMONEY S.A.C.
          </p>
        </div>
        ...
        <div class="card-content">
          <div class="control">
            <div class="content-btn-calculate">
              <a href="https://forms.gle/ynQgQooMRK5nfGEL8" target="_blank">
